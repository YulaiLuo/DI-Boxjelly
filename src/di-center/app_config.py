...
class Config:
    ...
    # AUTH_SERVICE_URL = os.environ.get('AUTH_SERVICE_URL') or 'http://localhost:8001/auth'
    MAP_SERVICE_URL = os.environ.get('MAP_SERVICE_URL') or 'http://di-map:8003/map'
    AUTH_SERVICE_URL = os.environ.get('AUTH_SERVICE_URL') or 'http://di-auth:8001/auth'
